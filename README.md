...
Download Smith & Sandwell "Global Topography V18.1" (https://topex.ucsd.edu/marine_topo/). Make sure **extract1m_modified.m** is in the path. This is a standalone function. Use it to add bathymetry to other data plots e.g.: SSbathymetry('/Users/lnferris/Desktop/topo_18.1.img',SearchLimits,'3Dsurf');
