...
You can use this software as is, but perhaps the greatest utility of ocean_data_tools is that you can build on it. Procedures are executed in plain view (e.g. functions are generally defined within the scripts themselves), allowing the user to track the flow of data. The code is yours to fork, modify, and slash apart.

Copyright (c) 2019 Lauren Newell Ferris. If this is useful to your research, cite as:
...
##### 10. ArgoTools.py (Python)

### World Ocean Database:
##### 11. World_Ocean_Database.m (Matlab script)
...
##### 14. GOSHIP_CTDO.py (Python)
##### 15. GOSHIP_ladcp_w.m (Matlab script)
##### 15. GOSHIP_ladcp_w.py (Python)
##### 16. GOSHIP_ladcp_vke.py (Python)
##### 16. GOSHIP_ladcp_vke.m (Matlab script)
##### 17. GOSHIP_lacdp_uv.m (Matlab script)

### Smith & Sandwell:
##### 18. SSbathymetry.m (Matlab function)
##### 19. SSsection.m (Matlab function)

### Utilities:
##### 20. NetCDF_variables.py (Python)
##### 21. shapeSubset.m (Matlab function)
...
##### 15. ladcp_w.m (Matlab script)
##### 15. ladcp_w.py (Python)
##### 16. ladcp_vke.py (Python)
##### 16. ladcp_vke.m (Matlab script)
##### 17. lacdp_uv.m (Matlab script)
