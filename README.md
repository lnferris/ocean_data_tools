...
* Want to make changes or add a new function? First 'fork' the repository (make your own separate copy); then make changes and open a 'pull request'. Once approved, it can be merged into the master branch. If you wish to chat beforehand about whether your contribution fits the scope of ocean_data_tools, open an issue or email lnferris@alum.mit.edu. 
