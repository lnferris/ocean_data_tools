...
For LADCP data. Recent data at (ftp://ftp.ldeo.columbia.edu/pub/ant/Data/), older data at (https://currents.soest.hawaii.edu/clivar/ladcp/). Scripts written for recent data but could be modified for older variable names.
