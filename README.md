...
You can use this software as is, but perhaps the greatest utility of ocean_data_tools is that you can build on it. Procedures are executed in plain view (e.g. functions are generally defined within the scripts themselves) so you can easily track the flow control. The scripts are yours to fork, modify and slash apart!
