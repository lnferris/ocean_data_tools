...
Basic scripts that pull data from the local directory or an online server (THREDDS, OPeNDAP, FTP), write them into data structures, and make plots. Please email me (lnferris@alum.mit.edu) with questions or bugs. Distributed under the terms of the MIT License, Copyright (c) 2018 lnferris. If this is useful for you, considering citing as:
