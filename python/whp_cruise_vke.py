...
def getStations(full_path):
    ...
    for filename in filename_list: # For each file in full_path...
        ...
        #'widx'# Window Index, m
        DEP = nc.variables['depth'][:] # Window Center Depth, m
        #'depth.min'# Window Min Depth, m
        #'depth.max'# Window Max Depth, m
        HAB = nc.variables['hab'][:] # Window Center Height Above Seabed
        #'nspec'# Number of Input Spectra in Window
        P0 = nc.variables['p0'][:] # Normalized VKE Density, W/kg
        ...
        EPS = nc.variables['eps.VKE'][:] # Turbulent Kinetic Energy Dissipation from Finescale VKE Parameterization
...
full_path = '/Users/lnferris/Documents/data/adcp/processed_w_20181230/*VKEprof.nc' # Data directory.
